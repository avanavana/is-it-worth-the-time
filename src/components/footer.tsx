...
export function PageFooter({
  ...
  const footerLinksLayoutClass =
    'flex flex-col items-start gap-y-2 content:flex-row content:flex-wrap content:items-center content:gap-y-0'
        ...
        >
          {commandRowVisible ? (
            <motion.div
              ...
              className="pointer-events-none flex flex-col items-start gap-4 content:flex-row content:flex-wrap content:gap-12"
            >
              <div className="flex w-auto flex-col gap-2 content:w-[189px]">
              ...
              <div className="flex w-auto flex-col gap-2 content:w-[123px]">
            ...
            <div
              className="pointer-events-none invisible flex flex-col items-start gap-4 content:flex-row content:flex-wrap content:gap-12"
              aria-hidden="true"
            >
              <div className="flex w-auto flex-col gap-2 content:w-[189px]">
                <div className="text-[10px] font-medium leading-4 text-muted-foreground">Navigate</div>
          ...
          {visibleActions.map((label, index) => (
            <Fragment key={label.label}>
              ...
              {index < visibleActions.length - 1 ? (
                <Separator aria-hidden className="hidden content:mx-4 content:block content:shrink-0" />
              ) : null}
            </Fragment>
          ))}
        </div>
